export const jsEvents = [
	...
	{
		name: 'Keyboard',
		text: 'onkeydown, onkeypress, onkeyup',
	},
	{
		name: 'Animation',
		text: 'animationend, animationiteration, animationstar',
	},

	{
		name: 'Miscellaneous',
		text: 'transitionend, onmessage, onmousewheel, ononline, onoffline, onpopstate, onshow, onstorage, ontoggle, onwheel, ontouchcancel, ontouchend, ontouchmove, ontouchstart',
	},
]
