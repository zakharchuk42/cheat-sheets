...
console.log(message);
			...
			<ul>
				...
				<li>
					...
					(Uninitialized). Особливий внутрішній стан, engine знає про
					змінну, але на неї не можна посилатися, поки вона не буде
					оголошена з let. Це майже те саме, що змінної не існує.
				</li>
				<li>
